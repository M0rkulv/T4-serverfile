...
set key=fxMwm06oBK0zri75fXei9cmapSICemAP
...
:server
start /wait /abovenormal bin\plutonium-bootstrapper-win32.exe t4mp "%gamepath%" -dedicated +set key %key% +set fs_game %mod% +exec %cfg% +set net_port %port% +map_rotate
